    ...
    var Chart = (function () {
        ...
        Chart.prototype.drawDashedLine = function (p1, p2, size) {
            ...
            while (q++ < dashes) {
                ...
                ctx[q % 2 === 0
                        ? 'moveTo'
                        : 'lineTo'](p1[0] * dpr, p1[1] * dpr);
            }
            ctx[q % 2 === 0
                    ? 'moveTo'
                    : 'lineTo'](p2[0] * dpr, p2[1] * dpr);
        };
        Chart.prototype.drawText = function (text, point, textColor) {
            ...
            ctx.font = this
                .font
                .replace(/(\d+)(px|em|rem|pt)/g, function (matched, m1, m2) {
                    return m1 * dpr + m2;
                });
    ...
    var KLine = (function (_super) {
        ...
        KLine.prototype.drawGrid = function () {
            var _a = this,
                ...
                grid = _a.grid,
                height = _a.height,
                figureWidth = _a.figureWidth,
                figureHeight = _a.figureHeight,
                figureOffsetHeight = _a.figureOffsetHeight,
                figureOffsetY = _a.figureOffsetY,
                volumeTopHeight = _a.volumeTopHeight;
            ctx.beginPath();
            this.drawLine({
                color: grid.color,
                startPoint: [
            ...
            for (var i = 0; i < grid.y; i++) {
                ...
                this.drawLine({
                    ...
                    points: [
                        [
                            figureWidth, gridY * i + figureOffsetY
                        ]
                    ]
                });
            }
        ...
        KLine.prototype.drawPriceBar = function () {
            var _a = this,
                ctx = _a.ctx,
                ohlcPrices = _a.ohlcPrices,
                dataCount = _a.dataCount,
                figureHeight = _a.figureHeight,
                figureOffsetHeight = _a.figureOffsetHeight;
            ...
            var maxPrice = Math
                .max
                .apply(null, highPrices);
            var minPrice = Math
                .min
                .apply(null, lowPrices);
            ...
            for (var i = 0; i < count; i++) {
                ...
                if (calcY(openPrice) === calcY(closePrice)) {
                    ...
                    this.drawLine({
                        ...
                        size: 4,
                        startPoint: [
                            barX, calcY(openPrice)
                        ],
                        points: [
                            [barX, calcY(closePrice)]
                        ]
                    });
                }
            }
        ...
        KLine.prototype.drawVolumeBar = function () {
            var _a = this,
                ...
                dataCount = _a.dataCount,
                height = _a.height,
                volumeHeight = _a.volumeHeight,
                textOffsetY = _a.textOffsetY,
                unitX = _a.unitX;
        ...
        KLine.prototype.drawMaLegend = function () {
            ...
            for (var i = len - 1, textWidth_1 = 0; i >= 0; i--) {
                ...
                textWidth_1 += ctx
                    ...
                    .width;
                this.drawText(text, [
                    figureWidth - textWidth_1,
                    figureOffsetY - 5
                ]);
                this.drawRound({
                    point: [
                        figureWidth - textWidth_1 - dot.radius - dot.paddingRight,
                        figureOffsetY - 5 - dot.radius
                    ],
                    radius: dot.radius,
                    isFill: true,
        ...
        KLine.prototype.drawAxisYText = function () {
            this.drawText(this.roofPrice.toFixed(2), [
                0, this.figureOffsetY - this.textOffsetY
            ]);
            this.drawText(this.floorPrice.toFixed(2), [
                0, this.figureHeight - this.textOffsetY
            ]);
        };
        KLine.prototype.drawGridX = function () {
            ...
            switch (Period[period]) {
                case 'Week':
                    ...
                    for (var i = 2; i < count - 2; i++) {
                        if (dates[i] !== dates[i - 1]) {
                            uniqDates.push({text: dates[i], index: i});
                        }
                    }
                ...
                case 'Month':
                    ...
                    for (var i = 2; i < count - 2; i++) {
                        if (dates[i] !== dates[i - 1]) {
                            monthDates.push({text: dates[i], index: i});
                        }
                    }
                    monthDates
                        .forEach(function (date) {
                ...
                default:
                    ...
                    for (var i = 2; i < count - 2; i++) {
                        if (dates[i] !== dates[i - 1]) {
                            dayDates.push({text: dates[i], index: i});
                        }
                    }
        ...
        KLine.prototype.getBarColor = function (bars, index) {
            var _a = this,
                riseColor = _a.riseColor,
                fallColor = _a.fallColor;
            ...
            if (closePrice > openPrice) {
                ...
                if (index === 0) {
                    ...
                    return closePrice > preClosePrice
                        ? riseColor
                        : fallColor;
                }
            }
...
(function (StockChart) {
    var TrendLine = (function (_super) {
        ...
        TrendLine.prototype.drawGrid = function () {
            ...
            for (var j = 0; j < grid.y; j++) {
                this.drawLine({
                    ...
                    points: [
                        [
                            figureWidth, gridY * j + figureOffsetY
                        ]
                    ]
                }, false);
            }
        ...
        TrendLine.prototype.drawPriceLine = function () {
            ...
            var _b = this,
                prices = _b.prices,
                preClosePrice = _b.preClosePrice,
                avgPrices = _b.avgPrices,
                isIndex = _b.isIndex;
            var isFlat = false;
            ...
            this.roofPercent = isSuspended
                ? '2.00%'
                : calcPercent(this.roofPrice);
            this.floorPercent = isSuspended
                ? '-2.00%'
                : calcPercent(this.floorPrice);
            var points = [];
        ...
        TrendLine.prototype.drawAxisText = function () {
            var _a = this,
                ...
                volumeHeight = _a.volumeHeight;
            var _b = this,
                roofPrice = _b.roofPrice,
                floorPrice = _b.floorPrice,
                preClosePrice = _b.preClosePrice,
                roofPercent = _b.roofPercent,
                floorPercent = _b.floorPercent;
            var axisY = height - volumeHeight;
            ...
            this.drawText(preClosePrice.toFixed(2), [
                0, figureOffsetHeight / 2 + roofY
            ]);
            this.drawText(roofPercent, [
                figureWidth - 35,
                roofY
            ]);
            this.drawText(floorPercent, [
                figureWidth - 40,
                floorY
            ]);
            this.drawText('0.00%', [
                figureWidth - 30,
                figureOffsetHeight / 2 + roofY
            ]);
        };
            ...
            for (var i = 0; i < volumes.length; i++) {
                ...
                this.drawLine({
                    ...
                    points: [
                        [
                            unitX * i,
                            height - (volumes[i] - minVolume) * volumeUnitY
                        ]
                    ]
                });
            }
